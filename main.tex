...
\affiliation{Department of Genome Sciences, University of Washington, Seattle}
%lets add the authors that Hamish wanted added ... that was in the document he sent with the description of the new instrument features.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\abbreviations{MS, LC-MS, DIA, HCD, AGC, CV\%}

\keywords{proteomics, Orbitrap, instrument evaluation, \LaTeX}
...
\section{Results}  % for ACS journals like JPR this will need to go after the methods section.
...
\begin{enumerate}
    ...
    \item Wider isolation windows (3-4 m/z compared to 2 m/z) result in slightly lower identification rates for both instruments, indicating a trade-off between isolation width and specificity. %lets use the "detection" language as opposed to "identification" languange. We are detecting peptides with DIA-NN not identifying them.
