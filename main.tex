...
\begin{enumerate}
    \item \textbf{Apex total ions}: The total number of ions detected in the mass spectrum at the apex (highest point) of a peptide’s liquid chromatography (LC) elution profile.
    \item \textbf{LC peak ion count fragment}: The summed ion counts for a peptide across its entire LC elution peak, reflecting total ion capture over time.
    \item \textbf{Apex LC peak ion count fragment}: The ion count specific to the peptide fragment at the LC peak apex, isolating signal intensity at the point of maximum chromatographic resolution.
\end{enumerate}
...
\subsubsection{Skyline settings for ion counting}
